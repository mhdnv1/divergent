...
jQuery(
  ".links-to-floor-li:eq(" + ascensor.data("current-floor") + ")"
).addClass("cv-active");

/* Menu click event */
jQuery("body")
  .find(".links-to-floor-li")
  .on("click", function (e) {
    "use strict";
    e.preventDefault();
...
jQuery("body")
  ...
  .on("click", function (e) {
    ...
    jQuery("body").find(".links-to-floor-li").removeClass("cv-active");
    /* Add class to the active menu item */
    jQuery('.links-to-floor-li[data-id="' + floornumber + '"]').addClass(
      "cv-active"
    );
    /* Close sidebar */
    jQuery("body").find(".cv-menu-button").removeClass("rotate-menu-icon");
...
jQuery(window).load(function () {
  ...
  if (window.location.hash) {
    ...
    var smenu = jQuery(".links-to-floor-li").filter(
      '[data-slug="' + hash + '"]'
    );
    jQuery("body").find(".links-to-floor-li").removeClass("cv-active");
  ...
  setTimeout(function () {
    jQuery("#home-slide-title span")
      .fadeIn()
      .removeClass("animated slideOutDown")
      .addClass("animated slideInUp");
    jQuery("#home-title h1")
      .fadeIn()
    ...
    jQuery("#cv-home-social-bar-container")
      .fadeIn()
      .removeClass("animated slideOutDown")
      .addClass("animated slideInUp");
  }, 1000);
...
jQuery("#cv-sidebar")
  ...
  .on("click", function () {
    ...
    if (nxt.is("ul") && !nxt.is(":visible")) {
      ...
      nxt.slideDown(100);
      jQuery("#cv-sidebar")
        .find(".cv-submenu > ul > li:has(ul) > a")
        .removeClass("cvdropdown2")
        .addClass("cvdropdown");
